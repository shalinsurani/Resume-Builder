      ...
      <div className="preview-header">
        ...
        <div className="template-selector">
          ...
          >
            ...
            <option value={RESUME_TEMPLATES.TEMPLATE12}>Professional Modern 2 (With photo)</option>
            <option value={RESUME_TEMPLATES.TEMPLATE31}> Modern (Professional with Photo)</option>
            <option value={RESUME_TEMPLATES.MODERN21}>Modern (Professional)</option>
            <option value={RESUME_TEMPLATES.MODERN69}>Creative Modern (Professional Two-Column Layout)</option>
            <option value={RESUME_TEMPLATES.TEMPLATE11}>Professional Modern</option>
          </select>
        </div>
      </div>
